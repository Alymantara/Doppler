pro stack_halpha
del=0.0625
readcol,'fases_stack.dat',spec,phase,velrad,format='A,D,D'
n=n_elements(spec)
i0=0
i1=0
i2=0
...
plot,w7,cosum7/i7,yra=[80,1800],xra=[6562.8-50,6562.8+50],ystyle=1
oplot,w0,cosum0/i0+100
oplot,w1,cosum1/i1+240
...
forprint,w0,cosum0/i0+100,/NOCOMMENT,textout='csum0.txt'
forprint,w1,cosum1/i1+240,/NOCOMMENT,textout='csum1.txt'
forprint,w2,cosum2/i2+440,/NOCOMMENT,textout='csum2.txt'
forprint,w3,cosum3/i3+730,/NOCOMMENT,textout='csum3.txt'
forprint,w4,cosum4/i4+880,/NOCOMMENT,textout='csum4.txt'
forprint,w5,cosum5/i5+1010,/NOCOMMENT,textout='csum5.txt'
forprint,w6,cosum6/i6+1200,/NOCOMMENT,textout='csum6.txt'
forprint,w7,cosum7/i7,/NOCOMMENT,textout='csum7.txt'
forprint,w7,cosum7/i7+1480,/NOCOMMENT,textout='csum8.txt'
